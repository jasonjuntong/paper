...
>   - **`Done` (6):** INFRA-001 (harness), USER-001 (component + e2e + integration), USER-002 (component + e2e), USER-003, USER-005 (both lanes), USER-007 (unit + integration + rules; e2e N/A — no standalone UI).
>   - **`Partial` (from the old `Done` set):** USER-004, PAPER-001, PAPER-003, PAPER-005, PAPER-006, PAPER-009, PAPER-018, ORG-001, ORG-004, ORG-006, ORG-014 — each ticket's Status line + `## Test coverage` section state the precise gap and any lane that legitimately doesn't apply.
